...
def getDefinedStrings(filepath):
    ...
    with open(filepath, 'r', encoding="latin-1") as file:
        content = file.read()
        srch = re.compile('Key ID\=\"(str_kolmiSFCM_[_a-zA-Z0-9]*)"', re.IGNORECASE)
...
def main(argv):
    ...
    if ("str_kolmiSFCM_tagging_name" in allUsedStrings): allUsedStrings.remove("str_kolmiSFCM_tagging_name") # Handle tagging macro
