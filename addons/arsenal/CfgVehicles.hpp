        ...
        class ACE_SelfActions {
            class GVAR(ScopeSelector) {
                ...
                class GVAR(ScopeSelectorEotech) {
                    ...
                    statement = "[_player, ""USMC_EXPS""] call kolmiSFCM_arsenal_fnc_SwitchScope";
                    showDisabled = 0;
                    icon = "";
                };
                class GVAR(ScopeSelectorEotechMagnifier) {
                    ...
                    condition = "[_player] call kolmiSFCM_arsenal_fnc_canSwitchScope";
                    exceptions[] = {"isNotSwimming"};
                    statement = "[_player, ""USMC_G33_EXPS_UP""] call kolmiSFCM_arsenal_fnc_SwitchScope";
                    showDisabled = 0;
                    icon = "";
                };
                class GVAR(ScopeSelectorVcog) {
                    ...
                    condition = "[_player] call kolmiSFCM_arsenal_fnc_canSwitchScope";
                    exceptions[] = {"isNotSwimming"};
                    statement = "[_player, ""USMC_optic_VCOG""] call kolmiSFCM_arsenal_fnc_SwitchScope";
                    showDisabled = 0;
                    icon = "";
                };
                ...
                class GVAR(ScopeSelectorLeupoldTS30A2) {
                    ...
                    exceptions[] = {"isNotSwimming"};
                    statement = "[_player, ""USMC_Optic_TS30A2""] call kolmiSFCM_arsenal_fnc_SwitchScope";
                    showDisabled = 0;
                    icon = "";
                };
            };
